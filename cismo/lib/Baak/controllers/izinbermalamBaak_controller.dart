...
import 'package:cismo/Baak/models/izinbermalamBaak.dart'; // Sesuaikan dengan lokasi file model IzinKeluar.dart Anda
...
class IzinBermalamBaakController {
 ...
 static Future<ApiResponse<String>> rejectIzinBermalam(int izinId) async {
  ...
  static Future<ApiResponse<List<IzinBermalam>>> viewAllRequestsForBaak() async {
    ...
    String token = await getToken();
      ...
      switch (response.statusCode) {
        case 200:
          ...
          List<IzinBermalam> izinKeluarList = data
              .map((json) => IzinBermalam.fromJson(json))
              .toList();
